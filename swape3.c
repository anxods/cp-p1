/*Exercise 3 (Global iterations) Right now we can use the -i option to set the number of swaps
performed by each thread. Change the implementation so that the -i option sets the number of
swaps performed between all the threads.*/
